    ...
    const entries = [
        {
            ...
            id: 'PI-0002',
            transactionCode: 'PI-0001',
            transactionDate: '20-11-2024',
            Coustmer: "kamran",
            WearHouse: "ans",
            GrossAmmount: "2132",
            status: 'Approved',
            ...
            id: 'JE-0002',
            transactionCode: 'PI-0003',
            transactionDate: '2-11-2024',
            Coustmer: "kainat",
            WearHouse: "ase",
            GrossAmmount: "33441",
            status: 'Approved',
                ...
                <div className="min-h-screen bg-white mt-10 ">
                    <div className="p-6 space-y-6">
                        ...
                        <div className="flex justify-between items-center">
                            ...
                            <button
                                onClick={() => navigate('/Purchase_inoice_form')} // Navigate to the journal page
                            ...
                            >
                                ...
                                <h1 className='sm:text-sm text-sm'>Purchase Invoice  </h1>
                            </button>
                                ...
                                <table className="w-full">
                                    <thead className="bg-gray-50">
                                        <tr>
                                            ...
                                            <th className="p-3 text-left font-medium">Refernce No</th>
                                    ...
                                    <tbody>
                                        {filteredEntries.map((entry) => (
                                            <tr key={entry.id} className="border-t hover:bg-gray-50">
                                                ...
                                                <td className="p-3">{entry.GrossAmmount}</td>      <td className="p-3">
                                              ...
                                              <td className="p-3">{entry.RefrenceNo}</td>
...
export default Purchase_inoice;