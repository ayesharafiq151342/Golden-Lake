...
const Purchase_Retrun = () => {
    ...
    const entries = [
        {
            id: 'PR-0001',
            transactionCode: 'PR-0002',
            transactionDate: '9-11-2024',
            Coustmer: "Kamran",
            WearHouse: "Main Store",
           status: 'Draft',
           
        },   {
            id: 'PR-0002',
            transactionCode: 'PR-0003',
            transactionDate: '2-2-2024',
            Coustmer: "Bilal",
            WearHouse: "Head Office",
           status: 'Approved',
           
        },   {
            id: 'PR-0003',
            transactionCode: 'PR-0003',
            transactionDate: '21-12-2024',
            Coustmer: "Abdullah",
            WearHouse: "Main STore",
           status: 'Approved',
            ...
            id: 'PR-0004',
            transactionCode: 'PR-0004',
            transactionDate: '4-11-2024',
            Coustmer: "Junaid",
            WearHouse: "Main store",
           status: 'Approved',
                ...
                <div className="min-h-screen bg-white mt-10 ">
                    <div className="p-6 space-y-6">
                        ...
                        <div className="flex justify-between items-center">
                            ...
                            <button
                                onClick={() => navigate('/Purchase_Retrun_form')} // Navigate to the journal page
...
export default Purchase_Retrun;