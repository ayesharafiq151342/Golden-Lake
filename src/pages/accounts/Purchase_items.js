                ...
                <div className="min-h-screen bg-white mt-10 ">
                    <div className="p-6 space-y-6">
                        ...
                        <div className="flex justify-between items-center">
                            <div>
                                <h1 className="text-2xl font-semibold">Items Details</h1>
                            ...
                            <button
                                onClick={() => navigate('/Purchase_item_form')} // Navigate to the journal page
                            ...
                            >
                                ...
                                <h1 className='sm:text-sm text-sm'>Create Items </h1>
                            </button>
