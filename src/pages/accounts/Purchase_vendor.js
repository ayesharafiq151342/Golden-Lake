...
function Purchase_vendor() {
    ...
    const handleHeaderClick = () => {
        navigate('/Purchase_vendor_form')  // Open the form when the header is clicked
    };
                ...
                <div className="min-h-52 bg-gray-50 rounded-xl">
                    <div className=" m-7  ">
                        ...
                        <div className="flex justify-between items-center">
                            ...
                            <button
                                onClick={() => navigate("/Purchase_vendor_form")}
                                ...
                                <table className="w-full">
                                    <thead className="bg-gray-50">
                                        <tr>
                                            ...
                                            <th className="p-3 text-left font-medium">Vendor Cateogry </th>
                                            <th className="p-3 text-left font-medium">Phone</th>
                                            <th className="p-3 text-left font-medium">Email</th>
                                            <th className="p-3 text-left font-medium">Adress</th>
                                            <th className="p-3 text-left font-medium">Code </th>
                                            <th className="p-3 text-left font-medium">Company Name</th>
                                    ...
                                    <tbody>
                                        {filteredEntries.map((entry) => (
                                            <tr key={entry.id} className="border-t hover:bg-gray-50">
                                                ...
                                                <td className="p-3" onClick={handleHeaderClick}>{entry.Createddate}</td>
                                                <td className="p-3" onClick={handleHeaderClick}>{entry.VendorCategory}</td>
                                                <td className="p-3" onClick={handleHeaderClick}>{entry.Phone}</td>
                                                <td className="p-3" onClick={handleHeaderClick}>{entry.Email}</td>
                                                <td className="p-3" onClick={handleHeaderClick}>{entry.Adress}</td>
                                                <td className="p-3" onClick={handleHeaderClick}>{entry.code}</td>
                                                <td className="p-3" onClick={handleHeaderClick}>{entry.Companyname}</td>
...
export default Purchase_vendor